...
create-bower-image:
	docker build -q --build-arg UID=1002 -t onyx/bower docker/images/packaging/bower/
...
create-gulp-image:
	docker build -q --build-arg UID=1002 -t onyx/gulp docker/images/packaging/gulp/
